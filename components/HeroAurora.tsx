...
export default function HeroAurora({
  badge = "Limited Seats • Register Now",
  headline = "The Ultimate Future & Innovation Event",
  subheadline = "Join founders, creators, and industry leaders for a high-energy experience packed with keynotes, live demos, networking, and breakthrough ideas.",
  primaryCta = { label: "Get Tickets", href: "#" },
  secondaryCta = { label: "View Schedule", href: "#" },
}: Partial<HeroAuroraProps>) {
  return (
    <AuroraBackground auroraColors={["#a855f7", "#ec4899", "#c084fc", "#f0abfc", "#d946ef"]}>
      <motion.div
        initial={{ opacity: 0, y: 40 }}
        whileInView={{ opacity: 1, y: 0 }}
        transition={{ delay: 0.3, duration: 0.8, ease: "easeInOut" }}
        className="relative animate-fade-in-up flex flex-col items-center justify-center gap-4 px-4 py-24 md:py-36"
      >
        {badge && (
